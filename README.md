...
occurrence from <strong>JRC Global Surface Water</strong> and topographic context
from <strong>USGS 3DEP (10 m)</strong>. Flood-prone areas are represented as
centroid-based points for rapid spatial screening and visualization.
</p>
